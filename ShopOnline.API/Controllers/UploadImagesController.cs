...
namespace ShopOnline.API.Controllers
{
    ...
    public class UploadImageController : ControllerBase
    {
        ...
        public void Post(UploadImage uploadImage)
        {
            ...
            var pathTemp = @"D:\Soft\Project\My Git Project\ShopOnline\WebRP\wwwroot\assets\images\product\Temp";
            var pathProduct = @"D:\Soft\Project\My Git Project\ShopOnline\WebRP\wwwroot\assets\images\product";
           //var pathTemp = @"F:\Document of Thanh\DotNetCore\ShopOnline\WebRP\wwwroot\assets\images\product\Temp";
            // ---------Đổi tên file-----------
            ...
            //Create product only id and PictureUri 
            Product product = new Product(){
                Id = uploadImage.ProductId,
                PictureUri = path 
            };
            
            //Crop and resize image width x height = 384x480
            int newWidth =384;
            int newHeight =480;
            ...
            //----------Xóa ảnh lưu tạm -------------
            // Tìm file
            string[] picList = Directory.GetFiles(pathTemp, newName);
            if (!(picList?.Length >0))
            { 
