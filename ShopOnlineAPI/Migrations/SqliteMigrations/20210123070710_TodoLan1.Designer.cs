...
namespace ShopOnlineAPI.Migrations.SqliteMigrations
{
    ...
    [Migration("20210123070710_TodoLan1")]
    partial class TodoLan1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.Products.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Models.Entities.Products.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Models.Entities.Products.Product", b =>
                {
                    b.HasOne("Models.Entities.Products.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandRefId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.Entities.Products.Type", "Type")
                        .WithMany()
